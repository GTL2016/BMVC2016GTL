...
\begin{tabular}{cc}
    ...
    \bmvaHangBox{\includegraphics[width=0.25\textwidth]{images/regression/lake_prediction}}&
    \bmvaHangBox{\includegraphics[width=0.18\textwidth]{images/regression/lake}}\\
\end{tabular}
